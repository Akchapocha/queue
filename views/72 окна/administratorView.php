...
<!--            --><?php
//                if (isset($conditionService)){
//                    if (intval($conditionService) === 0){
//                        echo '<h4 id="destination"><button>Включить распределение</button></h4>';
//                    } elseif (intval($conditionService) === 1){
//                        echo '<h4 id="destination"><button>Выключить распределение</button></h4>';
//                    }
//                }
//            ?>
